...
if(isset($_POST["registerinside"])){
  echo "<script>console.log('nothing selected;);</script>";
    if (!empty($_POST)) {
        ...
        $Uspwdc= mysqli_real_escape_string($conni , $_POST['PasswordCR']);
        $UsDate = date("Y-m-d h:i:sa");

        if ($Uspwd == $Uspwdc) {
            $inject="INSERT INTO Users (Email,Password,Dates) VALUES ('$UsEml','$Uspwd','$UsDate')";
            ...
            $var='<div class="alert alert-danger alert-dismissible" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    ...
                    <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                        <div class="panel panel-info">
                            ...
                            <div style="padding-top:30px" class="panel-body">
                                ...
                                <form id="loginform" class="form-horizontal" method="POST" action="login.php" role="form">
                                    ...
                                    <div style="margin-top:10px" class="form-group">
                                        <div class="col-sm-12 controls">
                                            <input type="submit" name="loginside" class="btn btn-primary" value="Login"> OR
                            ...
                            <div style="padding-top:30px" class="panel-body">
                                ...
                                <form id="signupform" class="form-horizontal" role="form" method="POST" action="login.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="password" class="form-control" name="PasswordCR" placeholder="Confirm Password">
                                        </div>
                                    </div>
